...
func (db *Migrator) getOldTransactions(batchSize int64, offset int64) ([]TransactionRow, error) {
...
func (db *Migrator) migrateTransactions(rows []TransactionRow, partitionSize int64) error {
...
func (db *Migrator) insertTransactionMessages(tx TransactionRow, partitionSize int64) error {
	partitionID := tx.Height / partitionSize
